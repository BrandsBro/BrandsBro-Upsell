export const loader = () => {
  const js = [
    ...
    "  var cd = document.querySelector('cart-drawer');",
    "  if (!cd) return;",
    "  if (cd.__bbPatched) { setTimeout(injectWidget, 100); return; }",
    "  var cd = document.querySelector('cart-drawer');",
    "  if (!cd || cd.__bbPatched) return;",
    "  cd.__bbPatched = true;",
    "  var orig = cd.renderContents.bind(cd);",
    "  cd.renderContents = function(state) { orig(state); cd.__bbPatched = false; setTimeout(function(){ patchRenderContents(); injectWidget(); }, 100); };",
    "}",

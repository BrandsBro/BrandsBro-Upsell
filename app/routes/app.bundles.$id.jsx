...
export default function BundleFormPage() {
  ...
  const handleSearch = useCallback(() => {
    ...
    fetcher.submit(
      { intent: "search_products", query: searchQuery },
      { method: "post" }
    );
  }, [searchQuery, fetcher]);
          ...
          <BlockStack gap="400">
            ...
            <Card>
              <BlockStack gap="400">
                ...
                {bundleProducts.length === 0 && (
                  <Banner tone="info">
                    Search for products above and add at least 2 to create a bundle.
                  </Banner>
                )}
              </BlockStack>
            </Card>
            ...
            <Card>
              <BlockStack gap="300">
                ...
                {bundleProducts.length >= 2 && (
                  <Banner tone="success">
                    Ready to save! Hit "Save & activate" above.
                  </Banner>
                )}
              </BlockStack>
            </Card>
